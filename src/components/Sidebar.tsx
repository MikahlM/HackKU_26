...
import { PieChart, Camera, Calendar, Users, Gamepad2, Store, Leaf } from 'lucide-react';

export default function Sidebar() {
  const navItems = [
    { path: '/', label: 'Dashboard', icon: PieChart },
    { path: '/log', label: 'Meal Log', icon: Camera },
    ...
    <nav className="sidebar">
      ...
      <div className="user-profile">
        ...
        <div className="user-info">
          ...
          <span className="user-level">Lvl 12 (450 XP)</span>
        </div>
      </div>
    </nav>
  );
